...
--
-- Host: localhost    Database: yii2shop
-- ------------------------------------------------------
...
INSERT INTO `category` VALUES (2,NULL,'Meja Kursi','meja-kursi'),(3,NULL,'Tempat Tidur','tempat-tidur');
...
INSERT INTO `migration` VALUES ('m000000_000000_base',1475302005),('m130524_201442_init',1475302009),('m141123_221351_shop',1475302017);
...
INSERT INTO `product` VALUES (1,'1 set Meja Kursi','1-set-meja-kursi','1 set meja kursi antik',2,34),(2,'meja kayu bundar','meja-kayu-bundar','meja kayu bundar lawas',2,60000);
...
INSERT INTO `user` VALUES (1,'admin','vcPGvRu4EKqeu9UC5zumnbBHgCbGHca8','$2y$13$G.qcIpCGptW/VnhJrzeTA.HgHOHYjJxPzKt7lzjWw0YX6h.WvMSsO',NULL,'admin@admin.com',10,1475381338,1475381338);
...
-- Dump completed on 2016-10-02 15:00:34
